...
<html lang="en">
  ...
  <body>
              ...
              <li class="nav-item active submenu">
                ...
                <div class="collapse show" id="base2">
                  <ul class="nav nav-collapse">
                    ...
                    <li class="active">
                      <a href="NNDataTable.jsp">
                        <span class="sub-item">Data Tables</span>
                      </a>
                    </li>
                    <li>
                      <a href="NNForm.jsp">
                        <span class="sub-item">Data Submit Form</span>
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">Data Competition</h4>
                      <button
                                ...
                                <div class="col-sm-12">
                                  <div class="form-group form-group-default">
                                    <label>Event Date</label>
                                      ...
                                      name="eventdate"
                                      class="form-control"
                                      placeholder="fill date" required
                                    />
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <tr>
                            ...
                            <td>
                              <!--  <div class="form-button-action">
                               ...
                               <button 
			                        ...
			                        data-noofparticipant="${event.noOfParticipant}"
			                        data-organizer="${event.organizer}"
			                        data-represents="${event.represents}">
			                        Edit
			                    </button>
                               
                              
                               <form action="deleteAchievement" method="post" style="display:inline;">
                          ...
                          <tr>
                            <td>Inter-School Coding Challenge</td>
                            <td>Competition</td>
                            <td>05/08/2023</td>
                            <td>Inter-School</td>
                            <td>
                          ...
                          <tr>
                            <td>State Robotics Tournament</td>
                            <td>Competition</td>
                            <td>18/06/2023</td>
                            <td>State</td>
                            <td>
                          ...
                          <tr>
                            <td>National Science Olympiad</td>
                            <td>Award</td>
                            <td>12/07/2023</td>
                            <td>National</td>
                            <td>
                          ...
                          <tr>
                            <td>Mathematics Challenge 2023</td>
                            <td>Competition</td>
                            <td>30/03/2023</td>
                            <td>School</td>
                            <td>
                          ...
                          <tr>
                            <td>International Debate Championship</td>
                            <td>Award</td>
                            <td>25/04/2023</td>
                            <td>International</td>
                            <td>
                          ...
                          <tr>
                            <td>State Environmental Challenge</td>
                            <td>Competition</td>
                            <td>16/01/2023</td>
                            <td>State</td>
                            <td>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const dataModal = document.getElementById("addRowModal");
        const achievementIdInput = document.getElementById("eventId");
        const achieverNameInput = document.getElementById("achieverName");
        const eventNameInput = document.getElementById("eventName");
        const eventDateInput = document.getElementById("date");
        const positionInput = document.getElementById("position");
        const representsInput = document.getElementById("represents");
        ...
        dataModal.addEventListener("show.bs.modal", function (event) {
			...
			<%-- if(button){
				if(button.classList.contains("edit-button")){
					achieverNameInput.value = "button works in edit-button" + button.getAttribute("data-id");
				} else {
					achieverNameInput.value = "button works but nnot in edit-button";	
				}
				 
			} else {
				 achieverNameInput.value = "nope";
			}--%>
            ...
            if (button.classList.contains("edit-button")) {
                ...
                // Clear fields for adding new data
                achievementIdInput.value = "";
                achieverNameInput.value = "";
                eventNameInput.value = "";
                eventDateInput.value = "";
                positionInput.value = "";
                representsInput.value = "";
                picInput.value = "";
                certificatesInput.value = "";

                dataForm.action = "addAchievement"; // Default form action
            }
