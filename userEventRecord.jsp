...
<html lang="en">
  ...
  <body>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">Events Record</h4>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <tr>
                            ...
                            <td>${event.venue}</td>
                            <td>${event.level}</td>
                            <td>${event.noOfParticipant}</td>
                            <td>${event.organizer}</td>
                            <td>${event.represents}</td>
                            <td>${event.status}</td>
                          </tr>
                          </c:forEach>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">Pending Event Record</h4>
                      <button
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-header border-0">
                           ...
                           <form action="userAddEvent" method="post" > 
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-header border-0">
                           ...
                           <form action="userEditEvent" method="post" > 
                          <div class="modal-body">
                            <p class="small">
                              Create a new row using this form, make sure you
                              fill them all
                      ...
                      >
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <form action="userCancelEvent" method="post" style="display:inline;">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const noOfParticipantInput = document.getElementById("editnoOfParticipant");
        const organizerInput = document.getElementById("editorganizer");
        ...
        dataModal.addEventListener("show.bs.modal", function (event) {
            ...
            if (button.classList.contains("edit-button")) {
               ...
               eventDateInput.value = button.getAttribute("data-eventDate");
               venueInput.value = button.getAttribute("data-venue");
               levelInput.value = button.getAttribute("data-level");
               noOfParticipantInput.value = button.getAttribute("data-noofparticipant");
               organizerInput.value = button.getAttribute("data-organizer");
