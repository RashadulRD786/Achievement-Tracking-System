          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Welcome to the dashboard!</h6>
              </div>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Approved Achievement</p>
                          <h4 class="card-title">${userapprovedachievementcount}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Approved Event</p>
                          <h4 class="card-title">${userapprovedeventcount}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
